...
public class Service02Stack extends Stack {
    ...
    public Service02Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic, Table productEventsDdb) {
        ...
        Queue produductEventsQueue = Queue.Builder.create(this, "ProductEvents")
        ...
        SqsSubscription sqsSubscription = SqsSubscription.Builder.create(produductEventsQueue).build();
        productEventsTopic.getTopic().addSubscription(sqsSubscription);

        Map<String, String> envVariables = new HashMap<>();
        envVariables.put("AWS_REGION", "us-east-1");
        envVariables.put("AWS_SQS_QUEUE_PRODUCT_EVENTS_NAME", produductEventsQueue.getQueueName());

        ApplicationLoadBalancedFargateService service02 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB02")
                .serviceName("service-02")
                .cluster(cluster)
                .cpu(512)
                .desiredCount(2) //Quantidade de instancias desejadas
                .listenerPort(9090) //porta que a appicação vai rodar
                .memoryLimitMiB(1024) //quantidade de memoria
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                .containerName("aws_project02")
                                .image(ContainerImage.fromRegistry("anekaroline/aws_project02:1.0.9"))
                                .containerPort(9090)
        ...
        produductEventsQueue.grantConsumeMessages(service02.getTaskDefinition().getTaskRole());
